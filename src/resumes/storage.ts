...
function renderResumeMarkdown(resume: NormalizedResumeData): string {
  const lines: string[] = [
...
export async function persistResumeArtifacts(
  ...
  await writeFile(resumeMarkdownPath, renderResumeMarkdown(params.resume), 'utf8');
